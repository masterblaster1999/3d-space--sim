...
- **Route Planner** (Market) suggests profitable in-system hauls and can auto-buy "best" cargo.

### In-system flight
- 6DOF-ish flight with dampers / boost / brake.
- Autopilot can fly to the current target.
- **Supercruise-lite** in-system travel assist (**H**) for fast in-system legs.
...
- Supercruise: **H** (toggle, requires a target)
- Time accel: **[ / ]** (step sim speed)
...
- Supercruise tuning + nav assist (“7-second rule”)
